...
function twitterClient () {
    ...
    return {
        ...
        getFavourites: function (action, user, done) {
            var results = [];
            ...
            return new Promise(function (resolve, reject) {
               var options = {
                ...
                config.get(action, options, function getData(error, favourites, response) {
                   if (!error) {
                       results = favourites;
                       console.log("Favourites length: " + results.length);
