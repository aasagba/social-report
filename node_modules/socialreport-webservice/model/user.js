                ...
                Promise.all(userInfo).then(function (userInfo) {
                    ...
                    userInfo.forEach( function (user) {
                        ...
                        var result = {
                            ...
                            accountlatest_status_date: "",
                            latest_status: "-"
                        }

                        if (user.statuses_count > 0) {
                            result.accountlatest_status_date = user.status.created_at;
                            result.latest_status = user.status.text;
                        }
                                  ...
                                  if (err) {
                                   ...
                                   globalmodel.friends.processFriends(user._id, user.accountid, function (err, results) {
                                       ...
                                       globalmodel.posts.getPostTimeline(user._id, user.channel, user.accountid, function (err, results) {
                                           ...
                                           // Update Favourites
                                           globalmodel.favourites.processFavourites(user._id, user.channel, user.accountid, function (err, results) {
                                               if (err) {
                                                   return req.reply().code(500);
                                               }
                                           });
