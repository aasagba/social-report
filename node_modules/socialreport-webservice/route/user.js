...
module.exports = function (app) {
    ...
    return [
        ...
        /*******************************************************************
         RUN GET FRIENDS SERVICE AND POPULATE DB

         Get Posts for user
         eg http://127.0.0.1:8000/run/friends?account=5846e35270e91934bb4bb3ab&accountname=BSI_Brazil
         *******************************************************************/
        {
            method: 'GET',
            path: '/run/friends',
         ...
         *******************************************************************/
       {
        ...
        /*******************************************************************
         ...
         Get Posts for user
         eg http://127.0.0.1:8000/run/followers?account=5846e35270e91934bb4bb3ab&accountname=BSI_Brazil
         *******************************************************************/
        {
            method: 'GET',
            path: '/run/followers',
        ...
        /*******************************************************************
         RUN GET FAVOURITES SERVICE AND POPULATE DB


         eg http://127.0.0.1:8000/run/favourites?account=5846e35970e91934bb4bb3ac&channel=twitter&accountname=BSI_France
         *******************************************************************/
        {
            method: 'GET',
            path: '/run/favourites',
            handler: function (req) {
                model.favourites.processFavourites(req.query.account, req.query.channel, req.query.accountname, function (err, favourites) {
                    if (err) {
                        return req.reply().code(500);
                    } else {
                        req.reply(favourites).code(200);
                    }
                });
            }
        },
        ...
        /*******************************************************************
         GET FAVOURITES FROM DB BY ACCOUNT


         eg http://127.0.0.1:8000/favourites?account=5846e35970e91934bb4bb3ac
         *******************************************************************/
        {
            method: 'GET',
            path: '/favourites',
            handler: function (req) {
                model.favourites.getFavourites(req.query.account, function (err, followers) {
                    if (err) {
                        return req.reply().code(500);
                    } else {
                        req.reply(followers).code(200);
        ...
        /*******************************************************************
         ...
         http://127.0.0.1:8000/user/run?client=elsevier
         *******************************************************************/
                    ...
                    if (err) {
                        ...
                        model.user.runByClient(users, function (err, results) {
                            if (err) {
                                ...
                                req.reply("Successfully Ran Social lookup for account: " + client).code(200);
                                //req.reply().code(202);
                            }
                        });
                    }
